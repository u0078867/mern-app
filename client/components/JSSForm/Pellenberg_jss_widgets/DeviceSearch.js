    ...
    return (
      <div ref="container">
        <Select.Async
          ...
          optionComponent={(props) => <DeviceSearchOption {...props} forms={this.props.formContext.forms} />}
          valueComponent={(props) => <DeviceSearchValue {...props} forms={this.props.formContext.forms} />}
